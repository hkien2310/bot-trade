...
class SmartMoneyConcepts(IStrategy):
    ...
    def populate_entry_trend(self, dataframe: pd.DataFrame, metadata: dict) -> pd.DataFrame:
        ...
        # Standard entry (same as v1)
        long_base = bullish_trend & in_discount & (in_bull_fvg | in_bull_ob) & vol_ok
        # Sweep entry (new in v2)
        long_sweep = liq_sweep_long & vol_ok
        ...
        short_base = bearish_trend & in_premium & (in_bear_fvg | in_bear_ob) & vol_ok
        short_sweep = liq_sweep_short & vol_ok
